...
public class QueueAndCostAndWaitStrategy extends ScheduleStrategy {
    @Override
    public int compare(TaskQueue taskQueue0, TaskQueue taskQueue1, long currentNs) {
        ...
        return ScheduleStrategyUtils.queueAndCostAndWait(queue0, queue1, monitor0, monitor1, currentNs);
    }
